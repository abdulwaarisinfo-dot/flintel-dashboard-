...
INDUSTRIES = {
 ...
 "salesforce", "salesforce alternative", "crm", "crm software", "crm platform",
    ...
    "CRM API limitations", "CRM lacks integrations", "RPM software integration device API",
    ...
    "chief revenue officer", "CRO", "sales operations analyst", "LinkedIn automation for founders", "LinkedIn post generator"
